...
<div class="container my-4">
    ...
    <p class="font-weight-bold">An example of material design mega menu. Bootstrap's mega menu is a navigation component which enhances the standard navbar features.Its extended dropdown contains images and categorized links.</p>

    <p><strong>Detailed documentation and more examples you can find in our <a href="https://mdbootstrap.com/docs/standard/extended/mega-menu/"
                                                                               target="_blank">Bootstrap Mega Menu Docs</a> </p>
                ...
                <li class="nav-item dropdown multi-level-dropdown">
                    ...
                    <ul class="dropdown-menu mt-2 rounded-0 pink darken-4 border-0 z-depth-1">
                        ...
                        <li class="dropdown-item dropdown-submenu p-0">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right mr-2 rounded-0 pink darken-4 border-0 z-depth-1">
                                <li class="dropdown-item p-0">
